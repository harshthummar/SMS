...
function Request()
{
    ...
    useEffect(() => {
     ...
     return(
        ...
        <lable>
            ...
            <select name="tournament" value={request.tournament} onChange={handlechange}>
                ...
                
                {
                    ...
                    //          <option>{item.Tournament}</option>:null
                    //         }
                    //         </>
            ...
            <select name="category" value={request.category} onChange={handlechange}>
                <option></option>
                {
                    ...
                    c.map((item) => {
                        ...
                        //     return (
                        //         <>
                        //         {item.Level===request.level && item.Tournament===request.tournament?
                        //          <option>{item.Gender}</option>:null
                        //         }
                        //         </>
        ...
        <label>
            Date:
            {/* <input type="date" name="date" value={winner.date} onChange={handlechange} placeholder="Date" /> */}
            <select name="date" value={request.data} onChange={handlechange}>
                <option></option>
                {
                   ...
                   d.map((item) => {
                    ...
                    //     return (
                    //         <>
                    //         {item.Level===request.level && item.Tournament===request.tournament && item.Gender===request.category?
                    //          <option>{item.Date}</option>:null
                    //         }
                    //         </>
        ...
        <label>
            venue:
            {/* <input type="text" name="venue" value={winner.venue} onChange={handlechange} placeholder="Venue" /> */}
            <select name="venue" value={request.venue} onChange={handlechange}>
                <option></option>
                {
                    ...
                    v.map((item) => {
                        ...
                        //     return (
                        //         <>
                        //         {item.Level===request.level && item.Tournament===request.tournament && item.Gender===request.category && item.Date===request.venue?
                        //          <option>{item.Venue}</option>:null
                        //         }
                        //         </>
